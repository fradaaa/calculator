...
const SwitchState = () => {
  ...
  const handleClick = (s: SwitchStateT) => () => {
    dispatch(updateSwitchState(s));
  };
  ...
  return (
    <SwitchContainer>
      ...
      >
        ...
        >
          <path
            ...
            stroke={switchState === "runtime" ? "#5D5FEF" : "#4D5562"}
            strokeWidth="2"
            strokeLinecap="round"
      ...
      <SwitchButton
        width={133}
        selected={switchState === "constructor"}
        className={inter.className}
      ...
      >
        ...
        >
          <path
            ...
            stroke={switchState === "runtime" ? "#4D5562" : "#5D5FEF"}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
